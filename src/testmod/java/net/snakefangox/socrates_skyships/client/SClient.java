...
import net.snakefangox.worldshell_fork.client.WorldShellEntityRenderer;
...
public class SClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.INSTANCE.register(SRegister.AIRSHIP_TYPE2, GhastShipRenderer::new);
    }
}
